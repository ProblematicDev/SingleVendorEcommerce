...
{
    /// <inheritdoc />
    public partial class fourthDBChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_UserEmail",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPaymentMethod", x => new { x.UserEmail, x.PaymentMethodId });
                    table.ForeignKey(
                        name: "FK_CustomerPaymentMethod_Customers_UserEmail",
                        column: x => x.UserEmail,
                        principalTable: "Customers",
                        principalColumn: "Email",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCustomAttributes_ProductVariants_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCustomAttributes_ProductVariantId",
